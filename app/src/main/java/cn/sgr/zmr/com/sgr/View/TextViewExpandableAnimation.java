...
//        textView.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.iv_expand_text_view_animation_toggle || v.getId() == R.id.tv_expand_text_view_animation_hint) {
            clickImageToggle();
        }
        if(v.getId()==R.id.iv_expand_text_view_animation_voice||v.getId()==R.id.text_voice){
            if(voiceClickListener!=null){
                voiceClickListener.ImageVice(v);
            }
        }
    ...
    public void setDrawableVoiceImage(int resid){
    ...
    public void setVoiceClickListener(VoiceClickListener titleBarAllClickListener) {
        this.voiceClickListener = titleBarAllClickListener;
    }
