 ...
 */
public class Baby_Of_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<Baby> datas;
    private Context context;
    private DaoCacheManage daoManage;

    public Baby_Of_Adapter(Context ct, List<Baby> list) {
                this.context=ct;
                this.datas = list;
            }
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.child_baby_item, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        mHolder.babay_tv_del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Utils.toNextActivity((Activity) context, LocationActivity.class);
            }
        });
    }
