...
public class BluetoothSet {
	...
	public BluetoothSet(Context context,TextView mTitView){
		mContext = context;
		mTitle = mTitView;
		isBusy = false;
				...
				case MESSAGE_STATE_CHANGE:
					...
					switch (msg.arg1) {
						...
						case BluetoothService.STATE_CONNECTING:
							Toast.makeText(mContext,R.string.title_connecting,Toast.LENGTH_SHORT).show();
...
//					getDataThread.setCommData(readMessage);
				...
				case MESSAGE_DEVICE_NAME:
					...
					MyApplication.DeviceName=mConnectedDeviceName;
				...
				try{
					...
					if (i == 500){
						if (getIsBusy()){
							...
							mHandler.sendMessage(msg);
							Toast.makeText(mContext,R.string.connected_outtime,Toast.LENGTH_SHORT).show();
