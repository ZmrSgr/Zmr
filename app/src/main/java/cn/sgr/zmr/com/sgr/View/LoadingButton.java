...
public class LoadingButton extends View{
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mArcPaint = new Paint();
        mArcPaint.setColor(getResources().getColor(R.color.them_bg));
        mArcPaint.setStyle(Paint.Style.STROKE);
        mArcPaint.setStrokeWidth(20);
        mArcPaint.setAntiAlias(true);

        mFillCirclePaint = new Paint();
        mFillCirclePaint.setColor(getResources().getColor(R.color.them_bg));
        mFillCirclePaint.setStyle(Paint.Style.FILL);
        mFillCirclePaint.setStrokeWidth(10);
        mFillCirclePaint.setAntiAlias(true);

        mCommonDrawable = getResources().getDrawable(R.drawable.update);
        mCompleteDrawable = getResources().getDrawable(R.drawable.update);
...
//开始动画
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(isDefaultDraw){
            ...
            isDrawableStart = false;
            isCompleted = false;
            targetProgress = currentProgress=15;
