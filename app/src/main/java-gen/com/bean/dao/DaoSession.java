...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig searchRecentDaoConfig;

    private final UserDao userDao;
    private final BabyDao babyDao;
    private final ChartDao chartDao;
    private final TreatDao treatDao;
    private final SearchRecentDao searchRecentDao;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        searchRecentDaoConfig = daoConfigMap.get(SearchRecentDao.class).clone();
        searchRecentDaoConfig.initIdentityScope(type);
        ...
        searchRecentDao = new SearchRecentDao(searchRecentDaoConfig, this);

        registerDao(User.class, userDao);
        registerDao(Baby.class, babyDao);
        registerDao(Chart.class, chartDao);
        registerDao(Treat.class, treatDao);
        registerDao(SearchRecent.class, searchRecentDao);
    }
    ...
    public void clear() {
        ...
        searchRecentDaoConfig.getIdentityScope().clear();
    }
    ...
    public SearchRecentDao getSearchRecentDao() {
